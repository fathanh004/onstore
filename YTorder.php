...
<head>
    ...
    <title>OnstorE : Youtube Premium</title>
...
<body>
    ...
    <form action="YTorder_action.php" method="post">
        <div class="card" style="width: 23rem; position:absolute; top: 20%; left: 40%; background-color: #a032a8; color:white;">
            <img src="Poster_YT.png" class="card-img-top">
            <div class="card-body">
                <h5 class="card-title" align="center">ORDER YOUTUBE PREMIUM</h5>
                <p class="card-text" align="center">Usahakan Menggunakan Email Fresh / Baru!</p>
            </div>
            <div align="center">
                <table border=0>
                    <tr>
                        ...
                        <td >:</td>
                        <td><input type="text" size="30" placeholder="YT 1 bulan 3.000" required /></td>
                    </tr>
                    <tr>
                        <td align="center">Email</td>
                        <td>:</td>
                        <td><input type="email" size="30" placeholder="contoh@gmail.com" required /></td>
                    </tr>
                    <tr>
