...
<body>
    ...
    <form action="MLorder_action.php" method="post">
        <div class="card" style="width: 23rem; position:absolute; top: 20%; left: 40%; background-color: #a032a8; color:white;">
            <img src="Poster_ML.png" class="card-img-top">
            <div class="card-body">
                <h5 class="card-title" align="center">ORDER MOBILE LEGEND</h5>
            ...
            <div align="center">
                <table border=0>
                    <tr>
                        ...
                        <td>:</td>
                        <td><input type="text" size="29" placeholder="86 DM 19.000" required /></td>
                    </tr>
                    <tr>
                        <td align="center">Nick</td>
                        <td>:</td>
                        <td><input type="text" size="29" placeholder="Nickname Mobile Legends Anda" required /></td>
                    </tr>
                    <tr>
                        <td align="center">Id (Server)</td>
                        <td>:</td>
                        <td><input type="text" size="29" placeholder="12345678 (12345)" required /></td>
                    </tr>
                    <tr>
